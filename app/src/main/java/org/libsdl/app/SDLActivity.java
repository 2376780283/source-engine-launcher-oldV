...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    private static final String KEY_SYSTEM_UI_VISIBILITY = "SystemUiVisibility";
    private static final String KEY_WINDOW_FLAGS = "WindowFlags";
...
//这里是新的设置本机参数
    ...
    Button btnAdditional = additionalLayout.findViewById(R.id.btnAdditional);
 ...
 Button btnCenter = additionalLayout.findViewById(R.id.btnCenter);
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (rightPopup[0] != null && rightPopup[0].isShowing()) {
                            rightPopup[0].dismiss();
                            rightPopup[0] = null;
                        } else {
                            rightPopup[0] = createPopupWindowRight();
                            if (rightPopup[0] != null) {
                                rightPopup[0].showAtLocation(clickedButton, Gravity.END, 0, 0);
                            }
                        }
                    }
                });
...
*/
    ...
    private void showywdts1Dialog() {
    final Dialog dialog = new Dialog(this);
    dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    dialog.setContentView(R.layout.r_yinweida);
    Window window = dialog.getWindow();
    if (window != null) {
        WindowManager.LayoutParams params = window.getAttributes();
        params.gravity = Gravity.TOP | Gravity.END; // 位置在右上角
        params.x = 0; // 调整水平
        params.y = 16; // 调整垂直位
    ...
    //这里是添加私有事件的方法 我找了一辈子
  private PopupWindow createPopupWindowRight() {
    PopupWindow popupWindow = new PopupWindow(this);
    popupWindow.setAnimationStyle(R.anim.slide_in_right);
    View popupView = LayoutInflater.from(this).inflate(R.layout.popup_right, null);
    ...
    popupView.startAnimation(animation);
        ...
        // 如果需要添加其他属性，可以在这里进行设置
        Button ddrButton = popupView.findViewById(R.id.backbutton);
        ddrButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //创建意图以启动下一个Activity
                        Intent intent = new Intent(SDLActivity.this, MainActivity.class);
                        startActivity(intent);
